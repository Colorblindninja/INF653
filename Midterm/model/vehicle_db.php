...
function get_vehicles_by_make($makeID) {
	...
	WHERE vehicles.vehicleMake = :makeID ORDER BY vehicleID';
...
function get_vehicles_by_type($typeID) {
	global $db;
	$query = 'SELECT * FROM vehicles
	WHERE vehicles.vehicleType = :typeID ORDER BY vehicleID';
	$statement = $db->prepare($query);
...
function get_vehicles_by_class($classID) {
	global $db;
	$query = 'SELECT * FROM vehicles
	WHERE vehicles.vehicleClass = :classID ORDER BY vehicleID';
	$statement = $db->prepare($query);
...
function get_all_vehicles() {
	global $db;
	$fetchQuery = 'SELECT * FROM vehicles';
