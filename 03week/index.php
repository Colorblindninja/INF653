...
//Fun Fact: wrote this query less than a mile from one of the addresses listed in the provided database. 
$query = 'SELECT C.customerID, C.emailAddress, C.firstName, C.lastName, A.line1, A.city, A.state, A.zipCode, A.phone FROM
customers C INNER JOIN addresses A ON C.customerID = A.customerID
